...
import { getOtherUserDetail } from "../../../../features/user/userActions"
...
const ProfileSetting = () => {
  ...
  useEffect(() => {
    dispatch(getOtherUserDetail({ userToken, id }));
  }, [id]);
  ...
  const handleSave = () => {
    dispatch(updateUser({ userToken, payload: { ...formData, id: userData._id } }));
  };
